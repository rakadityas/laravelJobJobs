          ...
          <div class="row"> 
              ...
              <div class="col-md-6" style="padding-top: 35px; text-align: center;"> 
                  <div class="row"> 
                      ...
                      <a href="{{url('/projectPosters')}}" style=" color: black"><div class="col-md-2" style="border-radius: 10px 0px 0px 10px; border:2px solid  #A5D6A7; color: gray; background-color: #81C784;padding: 10px">
                        <div class="button1"><b>Posters</b></div>
                      </div>
                      </a>
                      <a href="{{url('/projectPartners')}}"><div class="col-md-2" style="border-radius: 0px 10px 10px 0px; border:2px solid #4CAF50; background-color: #43A047; color: black; padding: 10px">
